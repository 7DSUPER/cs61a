...
def chain(t):
    ...
    for branch in t.branches:
        if branch.label == t.label and chain(branch):
            return True
    return False
...
# run_docstring_examples(chain, globals(), True)
run_docstring_examples(flatten_link, globals(), True)